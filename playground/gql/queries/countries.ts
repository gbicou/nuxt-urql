...
export type CountryByCodeQuery = (
  { __typename?: 'Query' }
  & { country?: Types.Maybe<(
    { __typename: 'Country' }
    & Pick<Types.Country, 'code' | 'name' | 'alpha3' | 'numeric'>
  )> }
)
